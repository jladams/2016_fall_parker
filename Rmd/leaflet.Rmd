...
This is the code and output for an instruction session on how to use the [leaflet](https://rstudio.github.io/leaflet/) R package to create interactive maps. 
...
[^1]:Data from [Inside Airbnb](http://www.insideairbnb.com)